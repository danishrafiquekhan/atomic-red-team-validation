...
Nothing here has been run yet. See `LAB-SETUP.md` for why (short version: it needs a Windows VM I have not built yet, on purpose, since it is a multi-GB download with a EULA I want to actually read first, not something to grab automatically).
